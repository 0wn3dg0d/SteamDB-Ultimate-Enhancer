...
// @include      https://steamdb.info/tag/*
...
(function() {
    ...
    function applyTotalSort() {
        ...
        const ratingHeader = document.querySelector('th[data-name="rating"]');

        if (!ratingHeader) {
            console.error('SteamDB Enhancer: Rating column not found for Total Sort.');
            return;
        }

        const ratingColumnIndex = ratingHeader.cellIndex;
